...
export default function CustomSelect({ value, onChange, options, placeholder = 'Selecionar...', className = '' }: CustomSelectProps) {
  ...
  return (
    <div className={`relative min-w-[160px] ${className}`} ref={containerRef}>
      <button
        ...
        className="flex items-center justify-between w-full bg-white border border-surface-border rounded-2xl px-4 h-10 text-xs font-bold text-brand-primary hover:border-brand-accent transition-all shadow-sm"
      >
