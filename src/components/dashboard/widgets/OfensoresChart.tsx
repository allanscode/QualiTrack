      ...
      {isEditing ? (
        ...
        <div className="flex items-center gap-3 mb-5 min-w-0">
          <div 
            ...
            className={`relative w-9 h-9 rounded-xl ${showDualLayout ? 'bg-icon-highlight text-brand-highlight' : 'bg-functional-error text-functional-error'} flex items-center justify-center flex-shrink-0 ${
          ...
          <div className="min-w-0 flex-1">
            <h3 className="text-sm font-black text-brand-primary uppercase tracking-widest leading-tight whitespace-normal" title="">{showDualLayout ? "Meus Ofensores & Maiores Acertos" : title}</h3>
          </div>
        </div>
      )}
    </>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 flex-1 min-h-0">
          ...
          <div className="flex flex-col h-full min-h-0">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h4 className="text-xs font-black uppercase tracking-widest text-functional-error">
                Meus Ofensores
              </h4>
              <span className="text-[10px] text-brand-muted font-bold">— Mais falhas</span>
            </div>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <Tooltip
                      ...
                      cursor={false}
                    />
                    <Bar dataKey="naoCount" radius={[0, 4, 4, 0]} maxBarSize={12}>
            ...
            {/* Ofensores Legend */}
            <div className="mt-4 pt-3 border-t border-surface-border/60 space-y-1.5 min-h-[72px]">
          ...
          <div className="flex flex-col h-full min-h-0 border-t md:border-t-0 md:border-l border-surface-border/60 pt-6 md:pt-0 md:pl-8">
            <div className="flex items-center gap-2 mb-4">
              <span className="w-2 h-2 rounded-full bg-functional-success" />
              <h4 className="text-xs font-black uppercase tracking-widest text-functional-success">
                Maiores Acertos
              </h4>
              <span className="text-[10px] text-brand-muted font-bold">— Mais conformidades</span>
            </div>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <Tooltip
                      ...
                      cursor={false}
                    />
                    <Bar dataKey="simCount" radius={[0, 4, 4, 0]} maxBarSize={12}>
            ...
            <div className="mt-4 pt-3 border-t border-surface-border/60 space-y-1.5 min-h-[72px]">
              {acertos.slice(0, 3).map((o, i) => (
                <div key={i} className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2 min-w-0 flex-1">
                    <span className="text-[9px] font-black text-functional-success bg-functional-success rounded px-1.5 py-0.5 flex-shrink-0">#{i + 1}</span>
                    <span className="text-[9px] font-bold text-brand-primary truncate">{o.fullText}</span>
                  </div>
